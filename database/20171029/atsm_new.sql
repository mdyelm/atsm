...
Source Database       : atsm

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2017-10-29 15:58:43
*/
...
CREATE TABLE `units` (
  ...
  `deleted_date` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `search` (`unit_id`,`license_id`,`organization_id`,`status`,`ip_address`)
...
CREATE TABLE `users` (
  ...
  `last_login_date` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `search` (`user_id`,`user_name`,`phone`,`mail_address`,`role`)

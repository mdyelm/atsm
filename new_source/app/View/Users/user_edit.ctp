<div class="col-lg-12">
    <div class="newBlock">
        <p class="nopd nomg">担当者の編集したい項目を入力し、最後に「確認」ボタンを押してください。</p>
    </div>
    <?php
    echo $this->Form->create('User', array(
        'url' => array('controller' => 'Users', 'action' => 'user_edit'),
        'id' => 'formUser',
        ...
        <tbody>
                ...
                <td>
                    <label class="pL5">
                        <?php if ($userRole['role'] == 1 || $userRole['role'] == 2): ?>
                            <?php if (isset($data) && isset($organization_name[$data['User']['organization_id']])): ?>
                ...
                <td>
                    <label class="pL5">
                        <?php if ($data['User']['role'] == 1): ?>
                            <?php $this->request->data['User']['role'] = 1; ?>
                        <?php elseif ($data['User']['role'] == 2): ?>
                            <?php $this->request->data['User']['role'] = 2; ?>
                        <?php elseif ($data['User']['role'] == 0): ?>
                            <?php $this->request->data['User']['role'] = ''; ?>
                        <?php endif; ?>
                        <?php if ($userRole['role'] == 1 || $userRole['role'] == 0): ?>
                            <?php
                            ...
                            ?>
                        <?php elseif ($userRole['role'] == 2): ?>
                            <?php if (isset($data) && isset(Configure::read('User.role1')[$data['User']['role']])): ?>
                                <?php echo h(Configure::read('User.role1')[$data['User']['role']]) ?>
                            <?php endif; ?>
                        <?php endif; ?>
                    </label> 
                </td>
            ...
            <?php else: ?>
                <tr class="cap permission_unit">
                    ...
                    <td>
                        <span class="dpUnit" style="margin-left: 15px;font-weight: bold"></span>
                    </td>
                </tr>
            <?php endif; ?>
            <tr class="cap">
                ...
                <td>
                    <label class="pL5">
                        ...
                        echo $this->Form->input('password_confirm', array(
                            ...
                            'div' => false,
                            'maxlength' => 15,
                            'value' => $data['User']['password_confirm']
                        ));
                        ?>
                    </label> 
                    <span class="mgL10 opaText">6文字から15文字以内半角英数字のみ</span>
